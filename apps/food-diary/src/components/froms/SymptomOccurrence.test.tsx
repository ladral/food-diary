...
import SymptomOccurrenceForm from "./SymptomOccurrence.tsx";
...
const mockSymptomService: ISymptomService = {
    createSymptom: vi.fn().mockResolvedValue({ id: 1, name: "Kopfschmerzen" }),
...
describe("SymptomOccurrenceForm Component", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
    ...
    it("submits the form", async () => {
        ...
        // assert
        await waitFor(() => {
            expect(mockSymptomService.createSymptomOccurrence).toHaveBeenCalledWith({
                symptom_id: 1,
                date: "2025-05-09"
            });
        });
    ...
    it("updates the date", async () => {
        ...
        // assert
        await waitFor(() => {
            expect(mockSymptomService.updateSymptomOccurrence).toHaveBeenCalledWith(expectedDiaryEntryId, {
                symptom_id: 1,
                date: "2025-06-10"
            });
        });
